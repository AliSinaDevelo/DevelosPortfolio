<footer
    class="py-20 sm:py-32 bg-black border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center" id="contact"
>
            ...
            <a href="alisinakarimi.2003@gmail.com" target="_blank" class="text-violet-400"
                >alisinakarimi.2003@gmail.com<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-brands fa-envelope fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span>
                    </sup
                ></a
            >
        ...
        <p>
            ...
            <a href="https://github.com/AliSinaDevelo/" target="_blank" class="text-violet-400"
                >AliSinaDevelo<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-brands fa-github fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
                    ></sup
                ></a
            >
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/alisina-karimi-43a834224/" target="_blank" class="text-violet-400"
                >Alisina Karimi<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-brands fa-linkedin-in fa-solid fa-arrow-up-right-from-square text-xs scale-[75%] "
                        /></span
                    ></sup
                ></a
            >
